...
export default function DeptAdminLayout({ children, departmentName }: Props) {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="flex flex-col w-64 shrink-0 bg-slate-900 text-white">
        ...
        <nav className="flex-1 py-4 px-2 space-y-1">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-slate-700 text-white text-sm">
